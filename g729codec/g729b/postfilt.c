 ...
 *---------------------------------------------------------------------------*/
  ...
  j = norm_l(temp);
  cmax = roundOS(L_shl(cor_max, j));
  en = roundOS(L_shl(ener, j));
  en0 = roundOS(L_shl(ener0, j));
